...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from '@/components/ui/index';
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {featuredListings.map((listing: any) => {
              ...
              return (
                <Card key={listingId} className="overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
                  <CardHeader className="p-0">
                    <Link href={`/listings/${listingId}`}>
                      <div className="relative h-56 w-full">
                        <Image
                          src={listing.photos?.[0] || 'https://placehold.co/600x400.png'}
                  ...
                  <CardContent className="p-4">
                    <CardTitle className="text-xl font-headline hover:text-primary transition-colors">
                      <Link href={`/listings/${listingId}`}>{listing.name}</Link>
                    </CardTitle>
                    ...
                    <div className="mt-2 flex items-center text-muted-foreground text-sm">
                      ...
                      <span>{listing.totalRooms || 0} rooms available</span>
                    </div>
                  </CardContent>
